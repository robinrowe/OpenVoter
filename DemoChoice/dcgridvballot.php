...
One radio button group per ranking
*/ ?>
...
<tr>
<th>&nbsp;</th>
<th colspan=<?php echo $Cands-$ExclCt; ?>>Preferences</th>
</tr>
...
?>
  ...
  <input type="radio" name="choice<?php echo $i1; ?>" value="<?php echo $Balrot[$i0]; ?>">
  </td>
...
<tr align=left><td style="border-top: thin solid;"><font size=2>None</font></td>
<?php
  for ($i1=1; $i1<=$Cands-$ExclCt; $i1++)
  { 
?>
  <td style="border-top: thin solid;">
  <input type="radio" name="choice<?php echo $i1; ?>" value="<?php echo $Cands; ?>" checked>
  </td>
<?php } ?>
</tr>
</table></center></td></tr>
