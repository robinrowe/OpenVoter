...
/*  create background*/
ImageFilledRectangle($image,0,0,200,200,$bkgd);
...
for ($i=0; $i<$slices; $i++)
{
 ...
 ImageFilledArc($image,100,100,198,198,$oldpos,$apos,$color[$i],0);
}
 
/*  draw circle  */
ImageFilledArc($image,100,100,198,198,0,360,$border,IMG_ARC_NOFILL);

/* rotate so angle zero is vertical */
$image=imagerotate($image,90,$bkgd);
