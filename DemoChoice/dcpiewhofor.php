...
<td><img src="<?php echo "pie.php".$qs ?>"
 alt="pies need GD2 extension"></td>
<?php if ($ValidBallot) { ?>
<td><img src=shim.gif alt="&nbsp;" width=40></td>
<td>
...
/*
      ...
      && abs($Elim[$RndNum])-1==$MyOrder[$RndNum])
   // middle condition avoids transfer of surplus if not recent
   // last condition prevents transfer when starting to equalize
  {
   $Weight[$MyOrder[$RndNum+1]]+=$Weight[$MyOrder[$RndNum]]*$Surplus[$RndNum];
   $Weight[$MyOrder[$RndNum]]*=(1-$Surplus[$RndNum]);
  }
*/
 } // if validballot
?>
...
<td><img src=shim.gif alt="&nbsp;" width=40></td>
<td><img src="<?php echo "pie.php".$qs ?>" alt="pies need GD"></td></tr></table>
